            ...
            if(isset($_POST['update']))
                    {
                      ...
                      $sql_update = "UPDATE rider SET rider_name = '".$_POST['rider_name']."', address = '".$_POST['address']."', 
                      phone_no = '".$_POST['phone_no']."', status = '".$_POST['status']."' WHERE rider_id = '".$_GET['rider_id']."'";
        ...
        <div class="content-wrapper">
            <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  <h3 class="font-weight-bold">Update Maqan Rider</h3>
            ...
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  ...
                  <?php if($total_rider>0) {do { ?>
                    <h4 class="card-title"><?php echo $rows_rider['rider_name'];?></h4>
                    <p class="card-description">
                    Rider ID: <?php echo $rows_rider['rider_id'];?>
                    </p>
                    <form class="forms-sample" method="post">
                      <div class="form-group">
                        <label>Rider Name</label>
                        <input type="text" name="rider_name" class="form-control" value="<?php echo $rows_rider['rider_name'];?>">
                      </div>
                      <div class="form-group">
                        <label>Address</label>
                        <input type="text" name="address" class="form-control" value="<?php echo $rows_rider['address'];?>">
                      </div>
                      <div class="form-group">
                        <label>Phone No</label>
                        <input type="text" name="phone_no" class="form-control" value="<?php echo $rows_rider['phone_no'];?>">
                      </div>
                      <div class="form-group">
                        <label>Status</label>
                          <select class="form-control" name="status" id="exampleSelectGender">
                            <option><?php echo $rows_rider['status'];?></option>
