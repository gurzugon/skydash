      ...
      <div class="main-panel">
        <div class="content-wrapper">
                ...
                <div class="col-md-12 grid-margin">
                  <div class="row">
                    <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                      <h3 class="font-weight-bold">Vendor Statement</h3>
            ...
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Search Vendor Statement</h4>
                    <form class="form-inline">
                      <label class="sr-only" for="inlineFormInputName2">Rider Name</label>
                           <select name="" class="form-control mb-2 mr-sm-2">
              ...
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Vendor Statement</h4>
                    <h4 class="card-title">Restaurant Name: Hijjaz</h4>
